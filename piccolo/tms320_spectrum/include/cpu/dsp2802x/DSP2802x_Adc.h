...
// Checkin $Date: February 1, 2010   13:38:36 $
//###########################################################################
//
// FILE:   DSP2802x_Adc.h
//
...
struct INTSEL_BITS {       // bits   description
    Uint16  INTODDSEL:5;        // 4:0    INTx EOC Source Select
    Uint16  INTODDE:1;          // 5      INTx Interrupt Enable
    Uint16  INTODDCONT:1;       // 6      INTx Continuous Mode Enable
    Uint16  rsvd1:1;          // 7      reserved
    Uint16  INTEVENSEL:5;        // 12:8   INTy EOC Source Select
    Uint16  INTEVENE:1;          // 13     INTy Interrupt Enable
    Uint16  INTEVENCONT:1;       // 14     INTy Continuous Mode Enable
    Uint16  rsvd2:1;          // 15     reserved
};

union INTSEL_REG {
    Uint16             all;
    struct INTSEL_BITS bit;
};

...
// Initialize address pointers to respective timer registers:
    ...
    CpuTimer0.int_mask = 0;
    CpuTimer1.int_mask = M_INT13;
    CpuTimer2.int_mask = 0;
...
{
	timer->RegsAddr->TCR.all = 0x4001;     // Use write-only instruction to set TSS bit = 0
	IER |= timer->int_mask;
}

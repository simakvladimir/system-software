...
static void sysctrl_clock_init_osc_sel (
  void
)
{
    EALLOW;
...
static void sysctrl_clock_init_pll(
  Uint16 val,
  Uint16 divsel
)
{
...
static void sysctrl_clock_disable_all(
   void
)
{
...
void sysctrl_clock_init(
   void
)
{
    sysctrl_clock_init_osc_sel();
    sysctrl_clock_init_pll(DSP28_PLLCR, DSP28_DIVSEL);
    sysctrl_clock_disable_all();
}

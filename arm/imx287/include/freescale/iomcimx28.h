 ...
 *                                   STRUCTS
 ********************************************************************************/
#define HW_RTC_CTRL_bit                   (*( __hw_rtc_ctrl_bits * )(0x80056000))
#define HW_RTC_PERSISTENT0_bit     (*( __hw_rtc_persistent0_bits * )(0x80056060))
#define HW_RTC_STAT_bit                   (*( __hw_rtc_stat_bits * )(0x80056010))
#define HW_CLKCTRL_CLKSEQ_bit       (*( __hw_clkctrl_clkseq_bits * )(0x800401D0))
#define HW_POWER_VDDDCTRL_bit       (*( __hw_power_vdddctrl_bits * )(0x80044040))
#define HW_POWER_VDDACTRL_bit       (*( __hw_power_vddactrl_bits * )(0x80044050))
#define HW_POWER_VDDIOCTRL_bit     (*( __hw_power_vddioctrl_bits * )(0x80044060))
#define HW_POWER_5VCTRL_bit           (*( __hw_power_5vctrl_bits * )(0x80044010))
#define HW_POWER_CTRL_bit 		   	    (*( __hw_power_ctrl_bits * )(0x80044000))
#define HW_POWER_VDDMEMCTRL_bit   (*( __hw_power_vddmemctrl_bits * )(0x80044070))
#define HW_POWER_LOOPCTRL_bit       (*( __hw_power_loopctrl_bits * )(0x800440B0))
#define HW_POWER_DCLIMITS_bit       (*( __hw_power_dclimits_bits * )(0x800440A0))
#define HW_POWER_MINPWR_bit           (*( __hw_power_minpwr_bits * )(0x80044020))
#define HW_LRADC_CONVERSION_bit   (*( __hw_lradc_conversion_bits * )(0x80050130))
#define HW_POWER_BATTMONITOR_bit (*( __hw_power_battmonitor_bits * )(0x800440E0))
#define HW_CLKCTRL_FRAC0_bit         (*( __hw_clkctrl_frac0_bits * )(0x800401B0))
#define HW_CLKCTRL_EMI_bit             (*( __hw_clkctrl_emi_bits * )(0x800400F0))
#define HW_CLKCTRL_HBUS_bit           (*( __hw_clkctrl_hbus_bits * )(0x80040060))
#define HW_CLKCTRL_CPU_bit             (*( __hw_clkctrl_cpu_bits * )(0x80040050))
#define HW_PINCTRL_MUXSEL10_bit   (*( __hw_pinctrl_muxsel10_bits * )(0x800181A0))
#define HW_PINCTRL_EMI_DS_CTRL_bit (*( __hw_pinctrl_emi_ds_ctrl_bits * )(0x80019B80))
#define HW_DRAM_CTL16_bit               (*( __hw_dram_ctl16_bits * )(0x800E0040))
#define HW_DRAM_CTL17_bit 				(*( __hw_dram_ctl17_bits * )(0x800E0044))
#define HW_CLKCTRL_PLL0CTRL0_bit (*( __hw_clkctrl_pll0_ctrl0_bits * )(0x80040000))
#define HW_ICOLL_CTRL_bit                (*( __hw_icoll_ctrl_bits * )(0x80000020))
#define HW_PINCTRL_MUXSEL6_bit      (*( __hw_pinctrl_muxsel6_bits * )(0x80018160))
#define HW_PINCTRL_DRIVE12_bit      (*( __hw_pinctrl_drive12_bits * )(0x800183C0))
#define HW_PINCTRL_MUXSEL7_bit      (*( __hw_pinctrl_muxsel7_bits * )(0x80018170))

#define HW_PINCTRL_MUXSEL4_bit      (*( __hw_pinctrl_muxsel4_bits * )(0x80018140))
#define HW_PINCTRL_DRIVE9_bit      (*( __hw_pinctrl_drive9_bits * )(0x80018390))
//__IO_REG32_BIT(HW_PINCTRL_DOE2_SET,       0x80018B24,__WRITE      ,__hw_pinctrl_doe2_bits);
//__IO_REG32_BIT(HW_PINCTRL_DRIVE9,         0x80018390,__READ_WRITE ,__hw_pinctrl_drive9_bits);
//__IO_REG32_BIT(HW_PINCTRL_MUXSEL4,        0x80018140,__READ_WRITE ,__hw_pinctrl_muxsel4_bits);
 ...
 *                                   VARIABLES
 ********************************************************************************/
#define HW_PINCTRL_MUXSEL10_CLR (*( __REG32 * )(0x800181A8))
#define HW_PINCTRL_MUXSEL11_CLR (*( __REG32 * )(0x800181B8))
#define HW_PINCTRL_MUXSEL12_CLR (*( __REG32 * )(0x800181C8))
#define HW_PINCTRL_MUXSEL13_CLR (*( __REG32 * )(0x800181D8))
#define HW_DRAM_CTL58 			(*( __REG32 * )(0x800E00E8))
#define HW_DRAM_CTL00 			(*( __REG32 * )(0x800E0000))
#define HW_ICOLL_VECTOR 		(*( __REG32 * )(0x80000000))
#define HW_ICOLL_LEVELACK 		(*( __REG32 * )(0x80000010))
#define HW_ICOLL_VBASE 		    (*( __REG32 * )(0x80000040))
#define HW_ICOLL_INTERRUPT0     (*( __REG32 * )(0x80000120))
#define HW_ICOLL_INTERRUPT0_SET (*( __REG32 * )(0x80000124))
#define HW_ICOLL_INTERRUPT0_CLR (*( __REG32 * )(0x80000128))

#define HW_PINCTRL_DOE2_SET     (*( __REG32 * )(0x80018B24))
#define HW_PINCTRL_DOE3_SET     (*( __REG32 * )(0x80018B34))

/* UART */
#define HW_UARTDBG_IMSC         (*( __REG32 * )(0x80074038))
#define HW_UARTDBG_IBRD         (*( __REG32 * )(0x80074024))
#define HW_UARTDBG_FBRD         (*( __REG32 * )(0x80074028))
#define HW_UARTDBG_H            (*( __REG32 * )(0x8007402C))
#define HW_UARTDBG_CR           (*( __REG32 * )(0x80074030))
#define HW_UARTDBG_DR           (*( __REG32 * )(0x80074000))
#define HW_UARTDBG_FR           (*( __REG32 * )(0x80074018))

/*TIMER 0*/
#define HW_TIMROT_TIMCTRL0      (*( __hw_timrot_timctrl_bits * )(0x80068020))
#define HW_TIMROT_TIMCTRL0_REG  (*( __REG32 * )(0x80068020))
#define HW_TIMROT_TIMCTRL0_CLR  (*( __hw_timrot_timctrl_bits * )(0x80068028))
#define HW_TIMROT_TIMCTRL0_CLR_REG  (*( __REG32 * )(0x80068028))
#define HW_TIMROT_TIMCTRL0_SET  (*( __hw_timrot_timctrl_bits * )(0x80068024))
#define HW_TIMROT_FIXED_COUNT0  (*( __REG32 * )(0x80068040))
#define HW_TIMROT_ROTCTRL       (*( __REG32 * )(0x80068000))

/*  TIMER 1 */
#define HW_TIMROT_TIMCTRL1      (*( __hw_timrot_timctrl_bits * )(0x80068060))
#define HW_TIMROT_TIMCTRL1_REG  (*( __REG32 * )(0x80068060))
#define HW_TIMROT_TIMCTRL1_CLR  (*( __hw_timrot_timctrl_bits * )(0x80068068))
#define HW_TIMROT_TIMCTRL1_CLR_REG  (*( __REG32 * )(0x80068068))
#define HW_TIMROT_TIMCTRL1_SET  (*( __hw_timrot_timctrl_bits * )(0x80068064))
#define HW_TIMROT_FIXED_COUNT1  (*( __REG32 * )(0x80068080))

/* TIMER 2 */
#define HW_TIMROT_TIMCTRL2      (*( __hw_timrot_timctrl_bits * )(0x800680A0))
#define HW_TIMROT_TIMCTRL2_REG  (*( __REG32 * )(0x800680A0))
#define HW_TIMROT_TIMCTRL2_CLR  (*( __hw_timrot_timctrl_bits * )(0x800680A8))
#define HW_TIMROT_TIMCTRL2_CLR_REG  (*( __REG32 * )(0x800680A8))
#define HW_TIMROT_TIMCTRL2_SET  (*( __hw_timrot_timctrl_bits * )(0x800680A4))
#define HW_TIMROT_FIXED_COUNT2  (*( __REG32 * )(0x800680C0))


/* GPIO */
#define HW_PINCTRL_DOUT2       (*( __hw_pinctrl_dout2_bits * )(0x80018720))
#define HW_PINCTRL_DOUT3       (*( __hw_pinctrl_dout3_bits * )(0x80018730))

 ...
 *                           ADD MCR
 **********************************************************/
#define __MRC( soproc,opcode_1,CRn,CRm,opcode_2 ) \
		__MRC_STR( soproc,opcode_1,CRn,CRm,opcode_2 )\

#define __MRC_STR( soproc,opcode_1,CRn,CRm,opcode_2 ) \
	({   \
	asm ( \
		 "MRC         p"#soproc","#opcode_1",R1,C" #CRn ",C" #CRm "," #opcode_2 "\n"\
		 "ldr R2,=temp\n" \
		 "str R1,[R2]\n" \
    );\
    temp;\
...
#define __MCR(soproc,opcode_1,value,CRn,CRm,opcode_2);\
 	 __MCR_STR( soproc,opcode_1,value,CRn,CRm,opcode_2 )\

#define __MCR_STR( soproc,opcode_1,value,CRn,CRm,opcode_2 ) \
	asm ( \
		 "ldr R1,[sp, #4]\n" \
		 "MCR         p"#soproc","#opcode_1",R1,C" #CRn ",C" #CRm "," #opcode_2 "\n"\
    );\
